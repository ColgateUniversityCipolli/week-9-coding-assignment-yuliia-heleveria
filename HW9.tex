...
\hldef{q.gamma.weibull} \hlkwb{<-} \hldef{Weibull.loglik}\hlopt{/}\hldef{Gamma.loglik}
...
\end{kframe}
\end{knitrout}
The likelihood ratio of the Weibull and the Gamma distribution is 1.0071345. Because $Q > 1$, the numerator provides a better fit for the data than the denominator. Weibull distribution is in the numerator, so it is a better fit according to the likelihood ratio. 
...
\hlcom{#compute the likelihood ratio}
\hldef{q.lognorm.weibull} \hlkwb{<-} \hldef{Weibull.loglik}\hlopt{/}\hldef{Lognorm.loglik}
...
\end{kframe}
\end{knitrout}
The likelihood ratio of the Weibull and the Log-Normal distribution is 0.9828942. Because $Q < 1$, the denominator provides a better fit for the data than the numerator. Log-Normal distribution is in the denominator, so it is a better fit according to the likelihood ratio. 
...
\begin{alltt}
\hlcom{#compute the likelihood ratio}
\hldef{q.gamma.lognorm} \hlkwb{<-} \hldef{Gamma.loglik}\hlopt{/}\hldef{Lognorm.loglik}
...
\end{kframe}
\end{knitrout}
The likelihood ratio of the Gamma and the Log-Normal distribution is 0.9759315. Because $Q < 1$, the denominator provides a better fit for the data than the numerator. Log-Normal distribution is in the denominator, so it is a better fit according to the likelihood ratio. 
  \end{enumerate}
